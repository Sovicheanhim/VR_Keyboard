...
namespace Panorama180View {
    ...
    public class Panorama180View : MonoBehaviour
    {
        ...
        */
        ...
        [SerializeField, Range(1.0f, 10000.0f)] float radius = 10.0f;           // 背景球の半径.
        ...
        private void m_CreateBackgroundSphere () {
            ...
            if (m_backgroundSphere == null) {
                ...
                m_backgroundSphere.transform.rotation = Quaternion.Euler(0, 90, 0);
                //m_backgroundSphere.transform.rotation = Quaternion.identity;
            }
        }
